...
class FirebaseService {
    ...
    async listAllConsultations(doctorId, options = {}) {
        try {
            // Usando collectionGroup para buscar todas as consultas sob "users/{doctorId}/patients"
            let q = query(
            ...
            const consultations = [];
            querySnapshot.forEach(docSnap => {
                // O path esperado: "users/{doctorId}/patients/{patientId}/consultations/{consultationId}"
