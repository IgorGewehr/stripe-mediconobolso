 ...
 *
 * Note: Storage service now uses doctor-server API instead of Firebase Storage.
 */

// Storage service - now uses doctor-server API
...
export const firebaseServices = {
  // Storage Service (now uses doctor-server API)
  uploadFile: (...args) => apiStorageService.uploadFile(...args),
  deleteFile: (...args) => apiStorageService.deleteFile(...args),
  getFileUrl: (...args) => apiStorageService.getFileUrl(...args),
  getStorageFileUrl: (...args) => apiStorageService.getStorageFileUrl(...args),
