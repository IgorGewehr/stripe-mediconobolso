...
function normalizePatient(patient) {
  ...
  return {
    ...
    physicalActivities: patient.atividades_fisicas || [],
    // Sinais vitais
...
function denormalizePatient(patient) {
  ...
  if (patient.healthPlan) {
    payload.convenio_nome = emptyToNull(patient.healthPlan.name);
  ...
  if (patient.physicalActivities !== undefined) payload.atividades_fisicas = emptyArrayToNull(patient.physicalActivities);
