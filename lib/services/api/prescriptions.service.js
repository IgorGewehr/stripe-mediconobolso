...
const prescriptionsService = {
  ...
  async uploadCertificate(file, password, usoPrincipal = true) {
    ...
    try {
      ...
      const response = await apiService.postForm('/doctor-certificates', formData);
  ...
  async createCertificate(patientId, certificateData) {
    ...
    try {
      ...
      const response = await apiService.post('/certificates', payload);
  ...
  async signCertificate(certificateId, signatureData = {}) {
    ...
    try {
      ...
      const response = await apiService.post(`/certificates/${certificateId}/sign`, payload);
      const result = normalizeMedicalCertificate(response);
  ...
  async downloadCertificatePdf(certificateId) {
    ...
    try {
      const result = await apiService.download(`/certificates/${certificateId}/pdf`);
