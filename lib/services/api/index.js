...
export { default as conveniosService } from './convenios.service';
...
export { default as emailCampaignService } from './emailCampaign.service';
export {
  EmailListSource,
  CampaignSourceType as EmailCampaignSourceType,
  CampaignStatus as EmailCampaignStatus,
  RecipientStatus as EmailRecipientStatus,
} from './emailCampaign.service';
export { default as whatsappCampaignService } from './whatsappCampaign.service';
export {
  CampaignSourceType as WhatsAppCampaignSourceType,
  CampaignStatus as WhatsAppCampaignStatus,
  RecipientStatus as WhatsAppRecipientStatus,
  MediaType as WhatsAppMediaType,
} from './whatsappCampaign.service';

// Verificação de Documentos (público)
export { default as verificationService } from './verification.service';

// Real-time services
export { default as websocketService } from './websocket.service';
export { default as presenceApiService } from './presence.service';
