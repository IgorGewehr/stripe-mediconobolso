...
const ViewNoteDialog = ({
    ...
    const renderAnamneseDetails = () => {
        ...
        const hasAnamneseDetails = noteData.chiefComplaint ||
            noteData.illnessHistory ||
            (noteData.physicalExam && Object.keys(noteData.physicalExam).length > 0);
            ...
            <Box sx={{ mt: 3 }}>
                {noteData.chiefComplaint && (
                    ...
                    >
                        ...
                        <AccordionDetails>
                            <Typography>{noteData.chiefComplaint}</Typography>
                        </AccordionDetails>
                    </Accordion>
                )}
                ...
                {noteData.illnessHistory && (
                    ...
                    >
                        ...
                        <AccordionDetails>
                            <Typography>{noteData.illnessHistory}</Typography>
                        </AccordionDetails>
                    </Accordion>
                )}

                {noteData.physicalExam && noteData.physicalExam.vitalSigns && (
                    <Accordion
                    ...
                    >
                        ...
                        <AccordionDetails>
                            <Grid container spacing={2}>
                                {noteData.physicalExam.vitalSigns.bloodPressure && (
                                    <Grid item xs={6} sm={4} md={2.4}>
                                        <Paper sx={{ p: 2, textAlign: 'center', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                                            ...
                                            <Typography variant="h6">{noteData.physicalExam.vitalSigns.bloodPressure} mmHg</Typography>
                                        </Paper>
                                    </Grid>
                                )}

                                {noteData.physicalExam.vitalSigns.heartRate && (
                                    <Grid item xs={6} sm={4} md={2.4}>
                                        <Paper sx={{ p: 2, textAlign: 'center', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                                            ...
                                            <Typography variant="h6">{noteData.physicalExam.vitalSigns.heartRate} bpm</Typography>
                                        </Paper>
                                    </Grid>
                                )}

                                {noteData.physicalExam.vitalSigns.temperature && (
                                    <Grid item xs={6} sm={4} md={2.4}>
                                        <Paper sx={{ p: 2, textAlign: 'center', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                                            ...
                                            <Typography variant="h6">{noteData.physicalExam.vitalSigns.temperature} °C</Typography>
                                        </Paper>
                                    </Grid>
                                )}

                                {noteData.physicalExam.vitalSigns.respiratoryRate && (
                                    <Grid item xs={6} sm={4} md={2.4}>
                                        <Paper sx={{ p: 2, textAlign: 'center', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                                            ...
                                            <Typography variant="h6">{noteData.physicalExam.vitalSigns.respiratoryRate} irpm</Typography>
                                        </Paper>
                                    </Grid>
                                )}

                                {noteData.physicalExam.vitalSigns.oxygenSaturation && (
                                    <Grid item xs={6} sm={4} md={2.4}>
                                        <Paper sx={{ p: 2, textAlign: 'center', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                                            ...
                                            <Typography variant="h6">{noteData.physicalExam.vitalSigns.oxygenSaturation}%</Typography>
                                        </Paper>
                                    </Grid>
                                )}
                            </Grid>
                ...
                {noteData.diagnosis && (
                    ...
                    >
                        ...
                        <AccordionDetails>
                            <Typography>{noteData.diagnosis}</Typography>
                        </AccordionDetails>
                    </Accordion>
                )}

                {noteData.treatmentPlan && (
                    <Accordion
                    ...
                    >
                        ...
                        <AccordionDetails>
                            <Typography>{noteData.treatmentPlan}</Typography>
                        </AccordionDetails>
                    </Accordion>
                )}
            </Box>
